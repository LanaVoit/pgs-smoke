...
public class Add_to_wishlist extends PGS.pages.TestBase {
  ...
  public void Add_to_wishlist() throws Exception {	
    ...
    ((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();"
            ,driver.findElement(By.xpath("//*[@id='item-7677']")));
    actions.moveToElement(driver.findElement(By.xpath("//*[@id='item-7677']"))).build().perform(); 
    ...
    actions.moveToElement(driver.findElement(By.xpath("//*[@id='item-7677']"))).build().perform(); 
    TimeUnit.SECONDS.sleep(5);
    driver.findElement(By.xpath("//*[@id='item-7677']/a[2]")).click();
    TimeUnit.SECONDS.sleep(5);    
    ...
    TimeUnit.SECONDS.sleep(5);
    assertEquals("Personalised Teddy and Maple Wooden Heart in a Tin has been added to your wishlist.", driver.findElement(By.cssSelector("span")).getText());
    ...
    TimeUnit.SECONDS.sleep(5);
    ((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();"
            ,driver.findElement(By.cssSelector("img[alt=\"Personalised Teddy and Maple Wooden Heart in a Tin\"]")));
    TimeUnit.SECONDS.sleep(5);
