...
public class Add_to_wishlist extends PGS.pages.TestBase {
  ...
  public void testUntitled6() throws Exception {	
    ...
    actions.moveToElement(driver.findElement(By.cssSelector("li#item-1914 a.product-image"))).build().perform(); 
    ...
    TimeUnit.SECONDS.sleep(5);
    actions.moveToElement(driver.findElement(By.cssSelector("li#item-1914 a.product-image"))).build().perform(); 
    driver.findElement(By.cssSelector("a[title=\"Add to Wishlist\"]")).click();
    TimeUnit.SECONDS.sleep(3);    
